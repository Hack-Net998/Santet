...
def user_dev():
  try:
  	print multi_ban
  	us = raw_input("\033[96;1m {\033[97;1m@\033[96;1m}\033[92;1m Masukkan Nama Target, Conth:\033[96;1m Wahyu\n\033[97;1m  ==> ")
  	jumlah = input("\n\033[96;1m\033[96;1m {\033[97;1m$\033[96;1m}\033[92;1m Jumlah Orang Yang Mau Di Hack?\033[96;1m (Max=1000):\n\033[93;1m  ==> ")
  	san_dev = raw_input("\n\033[96;1m\033[96;1m {\033[97;1m$\033[96;1m}\033[92;1m Kata Sandi Mungkin Yang Di Pake Dia, conth:\033[96;1m Wahyu123\n\033[97;1m  ==> ")
  	# set password
	...
	for dev in range(bag4, jumlah+1):
  	...
  	exit('\n\033[91;1m Masukkan Angka Goblog..\n')
  except SyntaxError:
	exit('\n\033[91;1m Masukkan Angka Goblog..\n ')
...
if __name__ == '__main__':
	...
	try:
		...
		print baner
		pil = raw_input("\033[96;1m {\033[95;1m?\033[96;1m}\033[92;1m Pilih Menu\033[93;1m : ")
		if pil == '1':
			brute()
		elif pil == '2':
			user_dev()
			...
			try:
				subprocess.check_output(['am', 'start', 'https://www.youtube.com/channel/UCcsUAiw8SO1_-kGGbsg2Ssg'])
			except KeyboardInterrupt:
				subprocess.check_output(['am', 'start', 'https://www.youtube.com/channel/UCcsUAiw8SO1_-kGGbsg2Ssg'])
			except WindowsError:
			...
			try:
				...
				print " \n\033[95;1m   Silahkan Ikuti Instagram saya \033[96;1m(Hack Net)"
				raw_input(" \033[97;1m    Tekan Enter Untuk Membuka Instagram..")
				subprocess.check_output(['am', 'start', 'https://www.instagram.com/draft.hacker/'])
				os.system('multi_dev.py' if os.name == 'nt' else 'python2 multi_dev.py')
			except KeyboardInterrupt:
			...
			print "\n\033[90;1m Pilih yang Bener lah Goblog "
			divev()
			deviv()
