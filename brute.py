...
def Wordlist():
	...
	try:
		...
		if nama1 == '' or nama2 == '':
			sys.exit("\n\033[91;1m Jangan Kosong Goblog!\n Kamu Keluar...")
...
def target():
	global target
	print string2
	user = raw_input("\033[96;1m {\033[97;1m@\033[96;1m}\033[92;1m Masukkan Nama Target Goblog:\n\033[93;1m  => \033[97;1m ")	
	if '08' not in user and '+62' not in user and '.' not in user and '1000' not in user and 'www.facebook.com' not in user and 'web.facebook.com' not in user or '@' in user[0]:
		print '\033[91;1m+'+'-'*38+'+'
		print "\033[97;1m Masukkin Username Goblog, Bukan Nama orangnya..\n Anda Orang Tolol \n Walaupun Anda Salah Sya Masih Sabar"
		print '\033[91;1m+'+'-'*38+'+'
